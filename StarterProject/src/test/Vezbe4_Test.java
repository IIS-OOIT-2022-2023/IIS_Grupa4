...
public class Vezbe4_Test {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Promenljiva tipa Point je ujedno instanca klase Point i klase Object 
		 * buduci da prosiruje klasu Object (kako je student istovremeno i student i osoba, 
		 * tako je i promenljiva point i instanca tipa Point i tipa Object)
		 * */
		...
		/*operator == poredi reference, odnosno proverava da li dve reference ukazuju na istu
		 *  fizicku strukturu podataka u memoriji, tj. da li ukazuju na isti objekat u memoriji. 
		 *  Operator new UVEK pravi u memoriji novi objekat.  
		*/
		...
		*/
		 ...
		 * da bismo imali logiku uporedjivanja vrednosti koordinata tacaka, 
		 * moramo da REDEFINISEMO metodu u klasi Point
		 * 
		...
		System.out.println(f == g); //tue

		String s1 = new String("Hello World");
		String s2 = new String("Hello World"); // kreira se novi objekat 
		System.out.println(s1==s2); //false
		System.out.println(s1.equals(s2)); // poredjenje po vrednosti jer je redefinisana u klasi String; true
