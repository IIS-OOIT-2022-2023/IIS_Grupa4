...
public class DlgColor extends JDialog {
	...
	public DlgColor() {
		...
		}
		{
			...
			gbc_txtGreen.anchor = GridBagConstraints.NORTH;
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							...
							/*
							 * Prilikom parsiranja string vrednosti, 
							 * moze doci do NumberFormatException,
							...
							if(r<0 || r>255 || g<0 || g>255 || b<0 || b>255) {
								JOptionPane.showMessageDialog(null, "Insert numeric values 0-255");
							}else {
